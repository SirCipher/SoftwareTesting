...
class AboutDialog extends JDialog {
    ...
    AboutDialog( JDialog parent ) {
        ...
        String copyright = "2005 - 2016 \u00a9 i-net software, Berlin, Germany";
        if( licensee != null && licensee.length() > 0 && "Commercial License".equalsIgnoreCase( license ) ) {
            ...
            content.add( Utils.getLabel( copyright ), gbc );
        } else {
            // GPL License
            content.add( Utils.getLabel( "JOrtho - GNU General Public License (GPL)" ), gbc );

            content.add( Utils.getLabel( copyright ), gbc );
            JLabel link = Utils.getLabel( "<html><u>https://www.inetsoftware.de/other-products/jortho</u></html>" );
